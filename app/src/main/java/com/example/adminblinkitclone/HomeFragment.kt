...
import com.example.adminblinkitclone.databinding.EditProductBinding
...
class HomeFragment : Fragment() {
    ...
    private fun getAllProducts(title: String?) {
        ...
        lifecycleScope.launch {
            viewModel.fetchAllProducts(title).collect{
                ...
                adapterProduct=ProductAdapter(::onEditButtonClicked)
    ...
    private fun onEditButtonClicked(product: Product){
        ...
        editProduct.save.setOnClickListener {
            ...
            Utils.Toast(requireContext(),"Changes Saved")
            alertDialog.dismiss()
        }
    }
