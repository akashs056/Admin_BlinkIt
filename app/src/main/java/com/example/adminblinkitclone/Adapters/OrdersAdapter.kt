...
import com.example.adminblinkitclone.databinding.SampleOrderBinding
...
class OrdersAdapter(val context: Context, val showOrderDetail: (OrderedItems) -> Unit):RecyclerView.Adapter<OrdersAdapter.viewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        return viewHolder(SampleOrderBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
